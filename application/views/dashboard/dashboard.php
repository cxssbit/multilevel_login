      ...
      <div class="content-center">
        <div class="row row-grid justify-content-between align-items-center text-left">
          ...
          <div class="col-lg-4 col-md-5">
            <img src="<?=base_url('assets/img/etherum.png')?>" alt="Circle image" class="img-fluid">
          </div>
        </div>
      </div>
    </div>
    ...
    <section class="section section-lg section-safe">
      <div class="container">
        <div class="row row-grid justify-content-between">
          <div class="col-md-5">
            <img src="<?=base_url('assets/img/chester-wade.jpg')?>" class="img-fluid floating">
    ...
    <section class="section section-lg section-coins">
      <img src="<?=base_url('assets/img/path3.png')?>" class="path">
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            <hr class="line-info">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="card card-coin card-plain">
              <div class="card-header">
                <img src="<?=base_url('assets/img/bitcoin.png')?>" class="img-center img-fluid">
              </div>
              <div class="card-body">
                <div class="row">
          ...
          <div class="col-md-4">
            <div class="card card-coin card-plain">
              <div class="card-header">
                <img src="<?=base_url('assets/img/etherum.png')?>" class="img-center img-fluid">
              </div>
              <div class="card-body">
                <div class="row">
                  <div class="col-md-12 text-center">
          ...
          <div class="col-md-4">
            <div class="card card-coin card-plain">
              <div class="card-header">
                <img src="<?=base_url('assets/img/ripp.png')?>" class="img-center img-fluid">
              </div>
              <div class="card-body">
                <div class="row">
                  <div class="col-md-12 text-center">
