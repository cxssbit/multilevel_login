        ...
        <div class="row">
          ...
          <div class="col-md-3">
            <ul class="nav">
              ...
              <li class="nav-item">
                <a href="<?=base_url('examples/landing-page.html')?>" class="nav-link">
                  Landing
                </a>
              </li>
              <li class="nav-item">
                <a href="<?=base_url('examples/register-page.html')?>" class="nav-link">
                  Register
                </a>
              </li>
              <li class="nav-item">
                <a href="<?=base_url('examples/profile-page.html')?>" class="nav-link">
                  Profile
                </a>
              </li>
            </ul>
